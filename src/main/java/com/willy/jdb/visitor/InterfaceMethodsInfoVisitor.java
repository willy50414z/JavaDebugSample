...
public class InterfaceMethodsInfoVisitor extends VoidVisitorAdapter<List<MethodInfoDto>> {
  @Override
  public void visit(ClassOrInterfaceDeclaration methodDeclaration, List<MethodInfoDto> result) {
